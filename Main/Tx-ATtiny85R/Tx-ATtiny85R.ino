/*
   ...
   Notes:
   * This is the code that is running on the ATtiny85 in the right mirror housing
...
int syncOffset = 0;   //Slight time offset so both mirrors don't transmit at the same time

//Define pins
#define hallA         A3  //Data pin of the hall sensor monitoring the up/down direction motor
#define hallB         A1  //Data pin of the hall sensor monitoring the left/right direction motor
